...
var ColorSwitcher = (function() {
    ...
    function initColorSwitcher(colorSheets) {
        ...
        colorSwitchs.addEventListener("click", function(event) {
			...
			var imagepath='images/logos/logo-'+imgstr.replace("switch to ", "")+'.png';
			$('.logo-default').attr('src',imagepath);
           // return false;

            var imagepath='images/logos/small-logo-'+imgstr.replace("switch to ", "")+'.png';
            $('.logo-sticky').attr('src',imagepath);
          //  return false;

            var imagepath='images/logos/small-logo1-'+imgstr.replace("switch to ", "")+'.png';
            $('.logo-sticky1').attr('src',imagepath);
          //  return false;

            var imagepath='images/logos/small-logo2-'+imgstr.replace("switch to ", "")+'.png';
            $('.logo-sticky2').attr('src',imagepath);
          //  return false;

            var imagepath='images/logos/small-logo3-'+imgstr.replace("switch to ", "")+'.png';
            $('.logo-sticky3').attr('src',imagepath);
          //  return false;


         //  var imagepath='images/logos/icons-'+imgstr.replace("switch to ", "")+'.png';
          //  $('.logo-sticky').attr('src',imagepath);
           // return false;

			// return false;
			var imagepath='images/logos/footer-'+imgstr.replace("switch to ", "")+'.png';
			$('.footer-default').attr('src',imagepath);
            return false;
